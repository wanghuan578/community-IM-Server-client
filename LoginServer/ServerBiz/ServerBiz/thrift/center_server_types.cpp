...
int _kMessageTypeValues[] = {
  ...
  MessageType::MT_USER_IDENTITY_CHACK_REQ,
  MessageType::MT_USER_IDENTITY_CHACK_RES,
...
const char* _kMessageTypeNames[] = {
  ...
  "MT_LEAVE_ROOM_REQ",
  "MT_LEAVE_ROOM_RES",
  "MT_USER_IDENTITY_CHACK_REQ",
  "MT_USER_IDENTITY_CHACK_RES",
  "MT_USER_QUERY_REQ",
  "MT_USER_QUERY_RES"
};
...
const char* CenterServerUserInfo::ascii_fingerprint = "50664258F37A5935397617A2C122E1CD";
const uint8_t CenterServerUserInfo::binary_fingerprint[16] = {0x50,0x66,0x42,0x58,0xF3,0x7A,0x59,0x35,0x39,0x76,0x17,0xA2,0xC1,0x22,0xE1,0xCD};
...
const char* CenterServerUserQueryRes::ascii_fingerprint = "B37CA99B3D14DF358EEB9E1D2BD79C40";
const uint8_t CenterServerUserQueryRes::binary_fingerprint[16] = {0xB3,0x7C,0xA9,0x9B,0x3D,0x14,0xDF,0x35,0x8E,0xEB,0x9E,0x1D,0x2B,0xD7,0x9C,0x40};
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->user_list.resize(_size18);
            uint32_t _i22;
            for (_i22 = 0; _i22 < _size18; ++_i22)
            {
              xfer += this->user_list[_i22].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t CenterServerUserQueryRes::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("user_list", ::apache::thrift::protocol::T_LIST, 3);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->user_list.size()));
    std::vector<CenterServerUserInfo> ::const_iterator _iter23;
    for (_iter23 = this->user_list.begin(); _iter23 != this->user_list.end(); ++_iter23)
    {
...
const char* CenterServerUserIdentityCheckReq::ascii_fingerprint = "DF0A12D34FF81EEB3676A01D662FDC86";
const uint8_t CenterServerUserIdentityCheckReq::binary_fingerprint[16] = {0xDF,0x0A,0x12,0xD3,0x4F,0xF8,0x1E,0xEB,0x36,0x76,0xA0,0x1D,0x66,0x2F,0xDC,0x86};

uint32_t CenterServerUserIdentityCheckReq::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t CenterServerUserIdentityCheckReq::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("CenterServerUserIdentityCheckReq");
  ...
  xfer += oprot->writeFieldBegin("login_time", ::apache::thrift::protocol::T_I64, 3);
  xfer += oprot->writeI64(this->login_time);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("check_sum", ::apache::thrift::protocol::T_STRING, 4);
