...
public:
    ...
    int open(int thread_number, uint queue_max_size, uint event_max_len=64, uint timedwait_interval_us=1000, bool timedwait_signal=true, int type=0, int timewait_db_alive = 14400000)
    {
        type_ = type;
