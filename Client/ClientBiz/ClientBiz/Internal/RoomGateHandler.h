...
class CRoomGateHandler : public SL_Socket_SendControl_Handler<SL_Socket_Message_Handler, SL_ByteBuffer, SL_Sync_SpinMutex, SL_Crypto_SymmetricCipher, SL_Crypto_SymmetricCipher>
{
public:
	CRoomGateHandler();
	~CRoomGateHandler();
