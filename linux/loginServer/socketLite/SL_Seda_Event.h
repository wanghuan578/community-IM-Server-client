...
typedef int(*SL_Seda_RpcTransmitProc)(int to_dest_id, void *transmit_message, int len);
...
struct SL_Seda_RpcTransmitEvent : public SL_Seda_FixedSizeEventBase<SL_Seda_RpcMessageEvent, SL_Seda_EventType::TRANSMIT_MESSAGE>
{
	int to_dest_id;
