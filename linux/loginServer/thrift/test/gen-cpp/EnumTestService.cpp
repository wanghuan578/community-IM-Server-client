...
::boost::shared_ptr< ::apache::thrift::TProcessor > EnumTestServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< EnumTestServiceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< EnumTestServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new EnumTestServiceProcessor(handler));
  return processor;
}
