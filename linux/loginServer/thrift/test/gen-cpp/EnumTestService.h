...
class EnumTestServiceIfSingletonFactory : virtual public EnumTestServiceIfFactory {
 public:
  EnumTestServiceIfSingletonFactory(const boost::shared_ptr<EnumTestServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<EnumTestServiceIf> iface_;
};
...
class EnumTestServiceClient : virtual public EnumTestServiceIf {
 public:
  EnumTestServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  EnumTestServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class EnumTestServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  EnumTestServiceProcessor(boost::shared_ptr<EnumTestServiceIf> iface) :
    iface_(iface) {
...
class EnumTestServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  EnumTestServiceProcessorFactory(const ::boost::shared_ptr< EnumTestServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< EnumTestServiceIfFactory > handlerFactory_;
};

class EnumTestServiceMultiface : virtual public EnumTestServiceIf {
 public:
  EnumTestServiceMultiface(std::vector<boost::shared_ptr<EnumTestServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~EnumTestServiceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<EnumTestServiceIf> > ifaces_;
  EnumTestServiceMultiface() {}
  void add(boost::shared_ptr<EnumTestServiceIf> iface) {
...
class EnumTestServiceConcurrentClient : virtual public EnumTestServiceIf {
 public:
  EnumTestServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  EnumTestServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
