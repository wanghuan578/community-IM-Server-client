...
int CDBProxyHandler::do_message(const char *msg, int len)
{
	...
	case common::MessageType::MT_HELLO_NOTIFY:
		{
			ret = SL_Rpc_MessageParser::message_to_event<MsgHelloNotify>((char*)msg, len, socket_, this, CMainStageHandler::DBProxyHelloNotify, &rpc_event, NULL);		
		}
		break;
		
	case dbproxy_server::MessageType::MT_LOGIN_CHECK_RES:
		{
			ret = SL_Rpc_MessageParser::message_to_event<MsgLoginCheckRes>((char*)msg, len, socket_, this, CMainStageHandler::LoginCheckRes, &rpc_event, NULL);		
		}
		break;

	case dbproxy_server::MessageType::MT_LOGIN_GET_USERINFO_RES:
		{
			ret = SL_Rpc_MessageParser::message_to_event<MsgLoginGetUserInfoRes>((char*)msg, len, socket_, this, CMainStageHandler::LoginGetUserInfoRes, &rpc_event, NULL);		
		}
		break;
...
int CDBProxyHandler::do_close()
{
	...
	expire_event.source = REGISTER_TYPE_DBPROXY;
